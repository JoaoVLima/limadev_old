...
async function init() {
    ...
    let obj_events = new Eventos([{
        ...
        "data": "09/12/2021",
        "tipo": "EP",
        "link_imagem": "https://i1.sndcdn.com/artworks-Dob0rgyCg3leaFzq-pDN43Q-t500x500.jpg",
        ...
        "link_bandcamp": "https://soundcloud.com/truno77/sets/valentine?si=dd3b2d052e804b15923ea12167806eb8&utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
        "link_youtube": "https://soundcloud.com/truno77/sets/valentine?si=dd3b2d052e804b15923ea12167806eb8&utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
        "link_applemusic": "https://soundcloud.com/truno77/sets/valentine?si=dd3b2d052e804b15923ea12167806eb8&utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
        "link_deezer": "https://soundcloud.com/truno77/sets/valentine?si=dd3b2d052e804b15923ea12167806eb8&utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing",
        "link_tidal": "https://soundcloud.com/truno77/sets/valentine?si=dd3b2d052e804b15923ea12167806eb8&utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing"
  }]);
    ...
    const sectionComponent = function (e:Evento, index:number) {
        ...
        wrapper_main.appendChild(icons);

        let lista_icones = ["fa-brands fa-spotify", "fa-brands fa-soundcloud", "fa-brands fa-bandcamp", "fa-brands fa-youtube", "fa-brands fa-applemusic", "fa-brands fa-deezer", "fa-brands fa-tidal"]
        let lista_link_icones = [e.link_spotify, e.link_soundcloud, e.link_bandcamp, e.link_youtube, e.link_applemusic, e.link_deezer, e.link_tidal]

        for (var i = 0; i < lista_link_icones.length; i++) {
            let link = lista_link_icones[i]
            let icone = lista_icones[i]
